...
//   try {
//     const notificationId = req.query.id as unknown as number;

//     if (!notificationId) {
//       return res.status(400).json({ message: "Invalid notification id" });
//     }

//     const notification = await mercadopago.payment.get(notificationId);

//     if (
//       notification &&
//       notification.body &&
//       notification.body.status === "approved"
//     ) {
...
//   // Esta es solo información básica, pero realmente deberá capturar la información importante que MP solicita a continuación
...
//         quantity: 1,
//         currency_id: "ARS",
//         unit_price: date.price as number
//       }
//     ],
//     payer: {
//       name: patient.name,
